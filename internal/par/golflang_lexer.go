...
const (
	...
	GolflangLexerQUOTE      = 9
	GolflangLexerLPAREN     = 10
	GolflangLexerRPAREN     = 11
	GolflangLexerLBRACKET   = 12
	GolflangLexerRBRACKET   = 13
	GolflangLexerLBRACE     = 14
	GolflangLexerRBRACE     = 15
	GolflangLexerDOT        = 16
	GolflangLexerCOMMA      = 17
	GolflangLexerCOLON      = 18
	GolflangLexerSEMICOLON  = 19
	GolflangLexerASSIGN     = 20
	GolflangLexerBACKSLASH  = 21
	GolflangLexerARROW      = 22
	GolflangLexerPLUS       = 23
	GolflangLexerMINUS      = 24
	GolflangLexerSTAR       = 25
	GolflangLexerSLASH      = 26
	GolflangLexerDOUBLESTAR = 27
	GolflangLexerUNDERSCORE = 28
	GolflangLexerGT         = 29
	GolflangLexerLT         = 30
	GolflangLexerEQ         = 31
	GolflangLexerGE         = 32
	GolflangLexerLE         = 33
	GolflangLexerNE         = 34
	GolflangLexerDOUBLELT   = 35
	GolflangLexerDOUBLEGTL  = 36
	GolflangLexerDOUBLEGTA  = 37
	GolflangLexerAMPERSAND  = 38
	GolflangLexerPIPE       = 39
	GolflangLexerCARET      = 40
	GolflangLexerIF         = 41
	GolflangLexerTHEN       = 42
	GolflangLexerELSE       = 43
	GolflangLexerIDENT      = 44
)
